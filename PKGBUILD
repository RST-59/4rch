...
# UI
depends+=('screenfetch' 'xorg-xhost' 'xorg-xinit' 'alsa-utils' 'xorg-xbacklight' 'i3lock-color-git' 'scrot' 'python-requests' 'xorg-xrandr' 'polybar' 'dialog' 'xorg-server' 'xorg-server-common' 'dmenu2' 'feh' 'i3-gaps' 'i3blocks')
# Fonts
